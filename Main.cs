    ...
    public class Main : Plugin
    {
        ...
        public bool ShowMe108()
        {
            try
            {
                ...
                Game.DisplayNotification("Showing 10-8 (Available for calls)");
                return true;
            }
            catch (Exception e)
            {
        ...
        public override void Initialize()
        {
            ...
            if (Utilities.IsLSPDFRPluginRunning("VocalDispatch", new System.Version(1, 5, 0, 0)) == true)
            {
                ...
                {
                    Game.LogTrivial("Status Plugin " + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.ToString() + " has failed to initialize.");
